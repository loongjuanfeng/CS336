...
def run_linear(
    ...
    return _run(Linear(d_in, d_out), {"weight": weights}, in_features)
...
def run_embedding(
    ...
    return _run(Embedding(vocab_size, d_model), {"weight": weights}, token_ids)
...
def run_swiglu(
    ...
    return _run(SwiGLU(d_model, d_ff), {"w1.weight": w1_weight, "w2.weight": w2_weight, "w3.weight": w3_weight}, in_features)
...
def run_multihead_self_attention(
    ...
    """
    return _run(MultiHeadSelfAttention(d_model, num_heads), _attention_weights(q_proj_weight, k_proj_weight, v_proj_weight, o_proj_weight), in_features)
...
def run_multihead_self_attention_with_rope(
    ...
    return _run(MultiHeadSelfAttention(d_model, num_heads, rope), _attention_weights(q_proj_weight, k_proj_weight, v_proj_weight, o_proj_weight), in_features, token_positions)
...
def run_transformer_block(
    ...
    """
    return _run(TransformerBlock(d_model, num_heads, d_ff, max_seq_len, theta), weights, in_features)
...
def run_transformer_lm(
    ...
    """
    return _run(TransformerLanguageModel(vocab_size, context_length, d_model, num_layers, num_heads, d_ff, rope_theta), weights, in_indices)
...
def run_rmsnorm(
    ...
    """
    return _run(RMSNorm(d_model, eps), {"weight": weights}, in_features)
